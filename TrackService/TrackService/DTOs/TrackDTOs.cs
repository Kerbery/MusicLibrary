...
namespace TrackService.DTOs.TrackDTOs
{
    ...
    public record GetTrackDTO(Guid Id, string Title, string Description, double Duration, string MediaUrl, string ArtworkUrl, string UrlId, DateTimeOffset UploadDate);
